...
export default function Timeline() {
  ...
  const eventos = [
    {
      year: "2003",
      title: t('timeline.e1_title'),
      icon: <FaLaptopCode size={28} />,
      desc: t('timeline.e1_desc'),
    },
    {
      year: "2014",
      title: t('timeline.e2_title'),
      icon: <FaGraduationCap size={28} />,
      desc: t('timeline.e2_desc'),
    },
    {
      year: "2019",
      title: t('timeline.e3_title'),
      icon: <FaServer size={28} />,
      desc: t('timeline.e3_desc'),
    },
    {
      year: "2021",
      title: t('timeline.e4_title'),
      icon: <FaNetworkWired size={28} />,
      desc: t('timeline.e4_desc'),
    },
    {
      year: "2024–2026",
      title: t('timeline.e5_title'),
      icon: <FaCode size={28} />,
      desc: t('timeline.e5_desc'),
    },
    {
      year: "2025",
      title: t('timeline.e6_title'),
      icon: <FaRobot size={28} />,
      desc: t('timeline.e6_desc'),
    },
    {
      year: "2026",
      title: t('timeline.e7_title'),
      icon: <FaShieldAlt size={28} />,
      desc: t('timeline.e7_desc'),
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0 flex flex-col items-center z-20 ml-2 md:ml-0">
        ...
        {/* Conector línea */}
        <span
          className={`h-full w-2 bg-gradient-to-b ${lineGradient} my-1 rounded-full hidden md:block`}
        />
      </div>
