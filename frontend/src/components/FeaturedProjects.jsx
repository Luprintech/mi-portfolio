...
const FeaturedProjects = () => {
  ...
  return (
    <section className="py-20 bg-white dark:bg-slate-800" id="featured-projects">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <div className="mt-6 md:mt-0">
            <Link 
              to="/proyectos" 
              className="group flex gap-2 items-center px-6 py-3 font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-700/50 rounded-lg hover:bg-blue-100 dark:hover:bg-slate-700 transition-colors"
            >
