...
/* Elementos de navegación con flag adminOnly para los exclusivos de admin */
const navItems = [
    {
        to: '/bitacora/inicio',
        label: 'Resumen',
...
export default function BitacoraLayout() {
    ...
    const NavContent = () => (
        <>
            {/* Usuario activo */}
            <div className="px-3 py-2.5 mb-2 rounded-xl bg-[var(--bg-elevated)] border border-[var(--border-default)] flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-fuchsia-600 to-cyan-500 flex items-center justify-center shrink-0">
                ...
                <div className="min-w-0">
                    ...
                    <span className={`text-[10px] font-medium uppercase tracking-wide ${
                        isAdmin ? 'text-fuchsia-400' : 'text-cyan-400'
                    }`}>
                        {role || '—'}
                    </span>
                </div>
