...
export default function PortfolioDocumentacion() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1220] text-white py-28 px-6 md:px-16 relative overflow-x-hidden selection:bg-cyan-500/30">
      {/* Background vibrante y activo para la zona de "Laboratorio" */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-fuchsia-900/10 via-[#0b1220] to-[#0b1220] pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto mb-16">
        <div className="bg-slate-900/60 border border-slate-700/50 p-6 sm:p-8 md:p-12 rounded-2xl shadow-[0_0_20px_rgba(34,211,238,0.05)] text-gray-300 text-lg leading-relaxed backdrop-blur-sm">
          ...
          <h3 className="text-xl font-bold text-cyan-400 mb-4 mt-8">{t('portfolio.docs_examples_title')}</h3>
          <ul className="list-disc list-inside space-y-3 mb-8 text-gray-400 marker:text-fuchsia-400">
            <li dangerouslySetInnerHTML={{ __html: t('portfolio.docs_ex1') }}></li>
            <li dangerouslySetInnerHTML={{ __html: t('portfolio.docs_ex2') }}></li>
            <li dangerouslySetInnerHTML={{ __html: t('portfolio.docs_ex3') }}></li>
            <li dangerouslySetInnerHTML={{ __html: t('portfolio.docs_ex4') }}></li>
            <li dangerouslySetInnerHTML={{ __html: t('portfolio.docs_ex5') }}></li>
          </ul>

          <div className="p-4 bg-slate-800/50 rounded-lg border-l-4 border-fuchsia-500">
      ...
      {/* Tarjeta final de enlace al canal */}
      <Motion.div 
